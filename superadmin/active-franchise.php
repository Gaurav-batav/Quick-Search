                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Active Franchise</h4>
                            </div>
                        </div>
                    </div>
                             <?php
                                        ...
                                        <div class="table-responsive table-card">
                                            <table class="table align-middle" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    $conn = $pdo->open();
                                                    try{
                                                    $stmt = $conn->prepare("SELECT * FROM tbl_franchise where status='Active' Order By creation_on DESC");
                                                    $cnt=1;
                                                    $stmt->execute();
                                                    foreach($stmt as $row){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="phone"><?php echo $row['email'];?></td>
                                                         <td class="phone"><?php echo $password;?></td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a href="dashboard-view.php?id=<?php echo $row['franchise_id'];?>" target="_blank"> <button class="dropdown-item" href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="25000351">
                                                                ...
                                                                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Change Status</button></a>
                                                                 ...
                                                                 <li>
                                                                    <a href="#password"  data-id="<?php echo $row['id'];?>" data-bs-toggle="modal" class="password"> <button class="dropdown-item">
                                                                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Change Password</button></a>
                                                                </li>
                                                                <li >
...
<?php include'active-franchise-popup.php';?>
