<div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="industry_add.php" class="needs-validation" enctype="multipart/form-data" novalidate>
                <div class="modal-body">
                    <div class="mb-3">
                        <div>
                            <label class="form-label">Industry <span class="text-red">*</span></label>
                            <input type="text" name="name" class="form-control" placeholder="Enter Industry name" required/>
                            <div class="invalid-feedback">Enter Industry name</div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Industry Icon <span class="text-red">*</span></label>
                        <input type="file" name="image" class="form-control" required/>
                        <div class="invalid-feedback">Select Industry Icon</div>
                    </div>
                    <div>
                        <label for="status-field" class="form-label">Status <span class="text-red">*</span></label>
                        ...
                        <div class="invalid-feedback">Select Industry Status</div>
                    </div>
                </div>
...
<div class="modal fade" id="edit" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" class="needs-validation" action="industry_edit.php" enctype="multipart/form-data" novalidate>
                <div class="modal-body">
                   <input type="hidden" class="distid" name="id">
                    <div class="mb-3">
                        <div>
                            <label class="form-label">Industry</label>
                            <input type="text" name="name" id="edit_name" class="form-control" placeholder="Enter Industry name" required/>
                            <div class="invalid-feedback">Enter Industry name</div>
                        </div>
                    </div>
                    <!--<div class="mb-3">
...
<div class="modal fade" id="status1" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light p-3">
            ...
            <form method="POST" action="edit_indu_icon.php" class="needs-validation" enctype="multipart/form-data" novalidate>
                <div class="modal-body">
                   <input type="hidden" class="distid" name="id">
                    <div class="mb-3">
                        <label class="form-label">Industry Icon</label>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="POST" action="delee_indu.php">
                                                        <input type="hidden" class="distid" name="id">
