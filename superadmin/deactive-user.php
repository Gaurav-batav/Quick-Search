                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Deactive Users</h4>
                                    ...
                                    <div>
                                        <div class="table-responsive table-card">
                                            <table class="table align-middle" id="customerTable">
                                                ...
                                                $conn = $pdo->open();
                                                try{
                                                $stmt = $conn->prepare("SELECT * FROM users where status='Deactive' Order By created_on DESC");
                                                $cnt=1;
                                                $stmt->execute();
                                                foreach($stmt as $row){
                                                ?>    
                                                    <tr>
                                                        ...
                                                        <td class="leadNo"><?php echo $row['user_id'];?></td>
                                                        <td class="company_name"> <?php echo $row['username'];?></td>
                                                        <td class="leads_score"> <?php echo $row['company'];?></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    <i class="ri-eye-fill align-bottom me-2 text-muted"></i>View</button></a></li>
