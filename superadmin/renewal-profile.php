                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Renewal Profile Data</h4>
                                        ...
                                        <div class="table-responsive table-card">
                                            <table class="table align-middle" id="customerTable">
                                                <thead class="table-light">
                                                   ...
                                                   <th class="sort" data-sort="Expire date">Expire Date</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    $conn = $pdo->open();
                                                    try{
                                                    $stmt = $conn->prepare("SELECT * FROM tbl_profile WHERE creation_on <= DATE_SUB(CURDATE(), INTERVAL 1 YEAR) Order By expire_date DESC");
                                                    $cnt=1;
                                                    $stmt->execute();
                                                    foreach($stmt as $row){
                                                    ?>   
                                                    <tr>
                                                        ...
                                                        <td class="FNo"><?php echo $row['expire_date'];?></td>
                                                        <td class="tags">
