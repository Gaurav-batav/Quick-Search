...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | QuickSearchOnline </title>
...
<body>
    <header id="page-topbar" class="headertop">
            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        ...
                        <span class="logo-lg">
                        <img src="assets/images/logo/logo.png" alt="" height="17" />
                        </span>
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                            <div data-simplebar style="max-height: 320px">
                                ...
                                <div class="dropdown-item bg-transparent text-wrap">
                                    <a href="index.php" class="btn btn-soft-secondary btn-sm rounded-pill">how to
                                            setup <i class="mdi mdi-magnify ms-1"></i></a>
                                    <a href="index.php" class="btn btn-soft-secondary btn-sm rounded-pill">buttons
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <i class="bx bx-message-square-dots"></i>
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        You have received
                                                        <b class="text-success">20</b> new messages in the conversation
                                                        </h6>
                                                        </a>
                                                        <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo $admin['first_name'];?> <?php echo $admin['last_name'];?>
                                           </span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <h6 class="dropdown-header">Welcome Shrikant!</h6>
                               ...
                               <!-- <a class="dropdown-item" href="#"><i
                                    ...
                                    <span class="align-middle">Notification</span></a>-->
