                                        ...
                                        <div class="table-responsive table-card">
                                            <table class="table align-middle" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    $conn = $pdo->open();
                                                    try{
                                                    $stmt = $conn->prepare("SELECT * FROM tbl_profile where status='Active' Order By tbl_profile.creation_on DESC");
                                                    $cnt=1;
                                                    $stmt->execute();
                                                    foreach($stmt as $row){
                                                    ?>   
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <div class="dropdown">
                                                                ...
                                                                <li>
                                                                    <a href="#assign"  data-id="<?php echo $row['id'];?>" data-bs-toggle="modal" class="assign"> <button class="dropdown-item">
                                                                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Assign To User</button></a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Change Paid Status</button></a>
                                                                </li>
...
<div class="modal fade" id="assign" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="assign_active.php" enctype="multipart/form-data" >
                <div class="modal-body">
                   <input type="hidden" class="distid" name="id">
                    <div>
                        <label for="status-field" class="form-label">Assign to user</label>
                       <select class="form-control" name="user_id" required>
                        ...
                        try{
                          ...
                          foreach($stmt as $row){
                        ?>
                        <option value="<?php echo $row['id'];?>"><?php echo $row['contact_info'];?></option>
                        <?php 
                              }
                            }
                        catch(PDOException $e){
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="p_active_p.php" enctype="multipart/form-data" >
                <div class="modal-body">
                   <input type="hidden" class="distid" name="id">
                    <div>
                        <label for="status-field" class="form-label">Paid Status</label>
                        <select class="form-control" name="paid_status" required>
                        <?php
                        $conn = $pdo->open();

                        try{
                          $stmt = $conn->prepare("SELECT * FROM tbl_paid");
                          $cnt=1;
                          $stmt->execute();
                          foreach($stmt as $row){
                        ?>
