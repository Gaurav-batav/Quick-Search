                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <!--ff-secondary-->
                                                         <?php
                                                         $id = $_GET['id'];
                                                        $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM tbl_profile WHERE franchise_id='$id' and status='Active'");
                                                        $stmt->execute();
                                                        $urow =  $stmt->fetch();

                                                        echo "<h4 class='fs-22 fw-semibold text-white mb-4'><span class='counter-value' data-target='".$urow['numrows']." '>0</span></h4>";?>
                                                       
                                                        <a href="#" class="text-decoration-underline text-white-50">View Active Profile</a>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                         <?php
                                                         $id = $_GET['id'];
                                                        $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM tbl_profile WHERE franchise_id='$id' and status='Deactive'");
                                                        $stmt->execute();
                                                        $urow =  $stmt->fetch();

                                                        echo "<h4 class='fs-22 fw-semibold text-white mb-4'><span class='counter-value' data-target='".$urow['numrows']." '>0</span></h4>";?>
                                                        <a href="#" class="text-decoration-underline text-white-50">View Deactive Profile</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <?php
                                                         $id = $_GET['id'];
                                                        $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM tbl_executive WHERE f_id='$id' ");
                                                        $stmt->execute();
                                                        $urow =  $stmt->fetch();
                                        ...
                                        <div class="table-responsive table-card">
                                              <table class="table align-middle" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    $conn = $pdo->open();
                                                    try{
                                                    $stmt = $conn->prepare("SELECT * FROM tbl_profile where franchise_id='$id' and status='Active' Order By creation_on DESC LIMIT 10");
                                                    $cnt=1;
                                                    $stmt->execute();
                                                    foreach($stmt as $row){
                                                    ?>   
                                               ...
                                               <table class="table align-middle" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                  ...
                                                  <?php
                                                    ...
                                                    $conn = $pdo->open();
                                                    try{
                                                    $stmt = $conn->prepare("SELECT * FROM tbl_executive where f_id='$id' Order By creation_on DESC");
                                                    $cnt=1;
                                                    $stmt->execute();
                                                    foreach($stmt as $row){
                                                    ?>   
