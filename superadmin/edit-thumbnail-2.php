...
if(isset($_POST['update']))
{
    ...
    if(!empty($filename)){
        ...
        // Resize the image to exact 600x500 dimensions
        $resize_result = resize_to_exact_dimensions($target_path, $target_path, 600, 500, $ext);
        
        if($resize_result) {
            // Delete old thumbnail if exists
            $old_thumb = $conn->query("SELECT thumbnail2 FROM tbl_profile WHERE id='$id'")->fetch_assoc()['thumbnail2'];
            if($old_thumb && file_exists('../uploads/original/'.$old_thumb)) {
                unlink('../uploads/original/'.$old_thumb);
            }
            
            $sql = "UPDATE tbl_profile SET thumbnail2='$new_filename' WHERE id='$id'";
            ...
            $_SESSION['error']="Failed to resize Thumbnail!";
        }
    } else {
        $_SESSION['error']="Please select a Thumbnail to update!";
    }
}
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Thumbnail</h4>
            ...
            <div class="row">
                <?php
                $id=intval($_GET['id']);
                $query=mysqli_query($conn,"SELECT thumbnail2 FROM tbl_profile WHERE id='$id'");
                    ...
                    <div class="col-xxl-8">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Edit Thumbnail</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <br>
                                        <span class="badge bg-info">Recommended: 600 x 500 pixels</span>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-8 text-center">
                                        ...
                                        <?php if(!empty($row['thumbnail2']) && file_exists('../uploads/original/' . $row['thumbnail2'])): ?>
                                            <img src="../uploads/original/<?php echo $row['thumbnail2'];?>" id="blah" class="img-thumbnail" >
                                            <small class="text-muted">Current Thumbnail</small>
                                        <?php else: ?>
                                            <img src="https://via.placeholder.com/600x500?text=No+Secondary+Photo" id="blah" class="img-thumbnail" >
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-start gap-3 mt-4">
                                    ...
                                    <button type="submit" class="btn btn-success btn-label right ms-auto" name="update">
                                        <i class="ri-save-line label-icon align-middle fs-16 ms-2"></i> Update Thumbnail
                                    </button>
                                </div>
                            </div>
                        </div>
...
imageInput.addEventListener('change', function(e) {
    ...
    if (files && files.length > 0) {
        ...
        reader.onload = function(event) {
            ...
            // Initialize cropper with 6:5 aspect ratio (600x500)
            cropper = new Cropper(imagePreview, {
                ...
                ready: function() {
                    ...
                    const cropBoxHeight = cropBoxWidth / (6/5);
...
cropButton.addEventListener('click', function() {
    if (cropper) {
        // Get the cropped canvas (600x500)
