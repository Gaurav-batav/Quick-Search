                            ...
                            <div class="card" id="customerList">
                                <div class="card-header border-bottom-dashed">
                                    ...
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0">Accepted Payment Mode </h5>
                                            </div>
                                        </div>

                                        <div class="col-xl-4">
                                                <div class="search-box">
                                                    <input type="text" class="form-control search" placeholder="Search for Industry Name,No,Date,Status and Something...">
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="d-flex flex-wrap align-items-start gap-2">
                                                ...
                                                <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add Payment Mode</button>
                                            ...
                                            <table class="table align-middle" id="customerTable">
                                                <thead class="table-light text-muted">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="email">Payment Mode</th>
                                                ...
                                                <form class="tablelist-form" autocomplete="off">
                                                    <div class="modal-body">
                                                        ...
                                                        <label for="id-field1" class="form-label">ID</label>
                                                         ...
                                                         <!--<div class="mb-3">
                                                            <label for="customername-field" class="form-label">Industry Name</label>
                                                        ...
                                                        <div class="mb-3">
                                                            <div>
                                                                    <label for="Sub-Industry-field" class="form-label">Payment Mode</label>
                                                                    <input type="text" id="Sub-Industry-field" class="form-control" placeholder="Enter Payment Mode" required />
                                                                </div>
                                                            </div>
                                                        <!--<div class="mb-3">
