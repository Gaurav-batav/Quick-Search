<div class="modal fade" id="photo" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" class="needs-validation" action="a_f_status.php" enctype="multipart/form-data" novalidate>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <div class="table-responsive "style="margin-left:20px">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content border-0">
                                                <div class="modal-header bg-info-subtle p-3">
                                                 ...
                                                 <form class="tablelist-form needs-validation" method="POST" action="franchise-add.php" novalidate>
                <div class="modal-body">
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input type="text" onkeypress="return isNumberKey(event)" maxlength="10" name="alt_phone" class="form-control" placeholder="Enter Alternative Phone" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div>
                            <label for="contact_email-field" class="form-label">Landline No</label>
                            <input type="text" class="form-control" onkeypress="return isNumberKey(event)" maxlength="10" name="landline_no" placeholder="Enter Landline No" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div>
                            <label for="contact_email-field" class="form-label">Alternative Landline No</label>
                            <input type="text" onkeypress="return isNumberKey(event)" maxlength="10" name="alt_landline_no" class="form-control" placeholder="Enter Alternative Landline No" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div>
                            <label for="contact_email-field" class="form-label">Contact Email <span class="text-red">*</span></label>
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input type="email" name="alt_email" class="form-control" placeholder="Enter contact email" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div>
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input type="text" name="adhar_no"  onkeypress="return isNumberKey(event)" class="form-control" placeholder="Enter Adhaar Card No." />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div>
                            <label for="contact_email-field" class="form-label">Pan Card No.</label>
                            <input type="text" name="pan_no" class="form-control" placeholder="Enter Pancard No." />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div>
                ...
                <div class="col-lg-12">
                    <div>
                        <label for="contact_email-field" class="form-label">Password <span class="text-red">*</span></label>
                        <input type="password" name="password" id="password" class="form-control" maxlength="6" placeholder="Enter Password" required />
                         <div class="invalid-feedback">Enter Password</div>
                    </div>
                </div>
                <div class="col-lg-12">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body p-5 text-center">
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        ...
                                                        <form method="POST" action="delete_franchise.php">
                                                             <input type="hidden" class="distid" name="id">
