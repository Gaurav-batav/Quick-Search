                ...
                <div class="profile-foreground position-relative mx-n4 mt-n4">
                    ...
                    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                        <div class="row g-4">
                            ...
                            <div class="col">
                                <div class="p-2">
                                    <h3 class="text-white mb-1">John Michael </h3>
                                                            ...
                                                            <table class="table table-borderless mb-0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">John Michael</td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">Lead  Designer/Developer</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Website :</th>
                                                                        <td class="text-muted">www.velzon.com</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
