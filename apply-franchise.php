...
if(isset($_POST['submit'])) {
    ...
    // Email to admin
    $subject = 'Franchise Application Request by '.$name;
    $message_body = '<html><body>';
    $message_body .= '<table rules="all" cellpadding="10">';
    $message_body .= "<tr style='background: #eee;'><td colspan='2'><strong>Franchise Application Details : <span style='color:#d24836'>". $name." </span> </strong> </td></tr>";
    ...
    $message_body .= "<tr><td><strong>City</strong> </td><td>: " . $city . "</td></tr>";
    ...
    $msg = $mail_sent 
        ? "<div class='alert alert-success'>Thank You! Your franchise application has been received.</div>"
        ...
        <div class="row align-items-center">
          ...
          <div class="col-xl-5 offset-xl-1 wow fadeInLeft" data-wow-delay="300ms">
             <div class="inquiry-form mb30-md ">
              ...
              <h2 class="title">Apply Franchise</h2>
              ...
              <?php echo $msg; ?>
                  ...
                  <div class="col-md-12">
                    <div class="mb20">
                      <label class="form-label fw600 dark-color"> City <span class="text-red">* </span></label>
