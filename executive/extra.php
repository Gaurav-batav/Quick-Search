                            ...
                            <div class="card crm-widget">
                                <div class="card-body p-0">
                                    <div class="row row-cols-xxl-5 row-cols-md-3 row-cols-1 g-0">
                                        <div class="col">
                                            <div class="py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">Total Data <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-md-0 py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">total follow up <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-md-0 py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">total Conversation <i class="ri-arrow-down-circle-line text-danger fs-18 float-end align-middle"></i></h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">today's data <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">industries  <i class="ri-arrow-down-circle-line text-danger fs-18 float-end align-middle"></i></h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                            ...
                                            <table class="table align-middle" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="name">lead No</th>
                                                        ...
                                                        <th class="sort" data-sort="date">Stutas </th>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <li ><a href="dashboard-view.php"> <button class="dropdown-item" href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="25000351">
                                                        ...
                                                        <!-- <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                ...
                                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View" data-bs-target="#showModal">
                                                                    <a href="dashboard-view.php"><i class="ri-eye-fill align-bottom text-muted"></i></a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="id" style="display:none;"><a href="javascript:void(0);" class="fw-medium link-primary">#VZ2101</a></td>
                                                        <td class="leadNo">#L11</td>
                                                        <td class="company_name">Force Medicines</td>
                                                        <td class="leads_score">Force Medicines</td>
                                                        <td class="phone">5804644694</td>
                                                        <td class="phone">@gmai.com</td>
                                                        <td class="location">Los Angeles, USA</td>
                                                        <td class="tags">
                                                            <span class="badge bg-primary-subtle text-primary">Industry</span>
                                                            <span class="badge bg-primary-subtle text-primary">Sub Industry</span>
                                                        ...
                                                        <td class="tags">
                                                        <span class="badge bg-secondary-subtle text-secondary">Deactive</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <span class="badge bg-warning-subtle text-warning">Deactive</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tags">
                                                        <span class="badge bg-danger-subtle text-danger">Active</span>                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tags">
                                                            ...
                                                            <span class="badge bg-info-subtle text-info">Deactive</span>
                                                        </td>
                                ...
                                <div>
                                    ...
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm-3">
                                            ...
                                            <h5 class="card-title mb-0">Follow Up Data</h5>
                                        </div>
