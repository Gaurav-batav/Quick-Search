...
<?php
	...
	$id = rand();
		...
		try{
			$stmt = $conn->prepare("UPDATE tbl_profile SET profile_id=:profile_id, company_name=:company_name, slug=:slug, experience=:experience, contact_person=:contact_person, phone=:phone, alt_phone=:alt_phone, whatsap_no=:whatsap_no, landline_no=:landline_no, alt_landline_no=:alt_landline_no, email=:email, alt_email=:alt_email, website=:website, state=:state, city=:city, zipcode=:zipcode, location=:location, description=:description  WHERE profile_id=:profile_id");
			$stmt->execute(['profile_id'=>$profile_id, 'company_name'=>$company_name, 'slug'=>$slug, 'experience'=>$experience, 'contact_person'=>$contact_person, 'phone'=>$phone, 'alt_phone'=>$alt_phone, 'whatsap_no'=>$whatsap_no, 'landline_no'=>$landline_no, 'alt_landline_no'=>$alt_landline_no, 'email'=>$email, 'alt_email'=>$alt_email, 'website'=>$website, 'state'=>$state, 'city'=>$city, 'zipcode'=>$zipcode, 'location'=>$location, 'description'=>$description]);
	    	$stmt1 = $conn->prepare("INSERT INTO users ( id, franchise_id, executive_id, name, email, contact_info, password, status) VALUES (:id, :franchise_id, :executive_id, :name , :email, :contact_info, :password, :status)");
			$stmt1->execute(['id'=>$id, 'franchise_id'=>$franchise_id, 'executive_id'=>$executive_id, 'name'=>$contact_person, 'email'=>$email, 'contact_info'=>$phone, 'password'=>$password, 'status'=>$status]);
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- end page title -->
                    <div class="row">
                        <form class="needs-validation" method="post" action="addprofile-step4.php" enctype="multipart/form-data"  novalidate>
                        <div class="col-xxl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-header align-items-center d-flex mt-10">
                                        <h4 class="card-title mb-0 flex-grow-1"><span class="text-blue-5">Step 4 :</span> Social Media</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="live-preview">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="url" class="form-control" name="fb" id="basic-url" aria-describedby="basic-addon3"placeholder="Enter URL">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                       ...
                                                       <div class="input-group">
                                                            ...
                                                            <input type="url" class="form-control" name="google" id="basic-url" aria-describedby="basic-addon3"placeholder="Enter URL">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                       ...
                                                       <div class="input-group">
                                                            ...
                                                            <input type="url" class="form-control" name="linkdin" id="basic-url" aria-describedby="basic-addon3"placeholder="Enter URL">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                       ...
                                                       <div class="input-group">
                                                            ...
                                                            <input type="url" class="form-control" name="youtube" id="basic-url" aria-describedby="basic-addon3"placeholder="Enter URL">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                       ...
                                                       <div class="input-group">
                                                            ...
                                                            <input type="url" class="form-control" name="insta" id="basic-url" aria-describedby="basic-addon3"placeholder="Enter URL">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                            ...
                                            <div class="d-flex align-items-start gap-3 mt-5">
                                                 ...
                                                 <!--   <a class="btn btn-success btn-label right ms-auto nexttab nexttab" href="addprofile-step4.php" role="button"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Next</a>-->
                                                    <button type="submit" class="btn btn-success btn-label right ms-auto nexttab " name="add2"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Next</button>
                                                </div>
                                            </div>
