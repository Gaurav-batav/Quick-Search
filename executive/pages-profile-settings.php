                            ...
                            <div class="card mt-n5">
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <h5 class="fs-16 mb-1">Mr Arjun</h5>
                                        ...
                                        <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                            <form action="javascript:void(0);">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Executive Name</label>
                                                            <input type="text" class="form-control" id="firstnameInput" placeholder="Enter your Executive Name" value="Arjun">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="Revenew" class="form-label">Revenew</label>
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter Revenew" >
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                     <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="DeactiveProfiles" class="form-label">Deactive Profiles</label>
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter Deactive Profiles" >
                                                        </div>
                                                    </div>
