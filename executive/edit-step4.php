                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1"><span class="text-blue-5">Step 4 :</span> Image Gallery</h4>
                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                        <div>
                                            <h5 class="fs-15 mb-4"> Image Size (400 x 300)</h5>
                                           <!-- <p class="text-muted">Use <code>input-group</code> class to div element which contains input attribute to wrap a default input in the group.</p>-->
                                            <div class="row g-3">
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                     <a class="btn btn-link text-decoration-none btn-label previestab" href="edit-step2.php" role="button"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i> Back</a>
                                                     <a class="btn btn-success btn-label right ms-auto nexttab nexttab" href="edit-step5.php" role="button"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Submit</a>
