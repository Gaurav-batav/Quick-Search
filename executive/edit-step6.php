                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                   <h4 class="card-title mb-0 flex-grow-1"><span class="text-blue-5">Step 7 :</span> Accepted Payment Mode</h4>
                                    ...
                                    <div class="live-preview">
                                        <div class="table-responsive">
                                            ...
                                            <div class="d-flex align-items-start gap-3 mt-4">
                                                     <a class="btn btn-link text-decoration-none btn-label previestab" href="edit-step5.php" role="button"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i> Back</a>
                                                     <a class="btn btn-success btn-label right ms-auto nexttab nexttab" href="edit-finish.php" role="button"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Submit</a>
