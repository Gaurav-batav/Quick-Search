...
<!-- auth-twostep-cover12:36:29 GMT -->
<head>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="text-muted text-center mx-lg-3">
                                            <h4 class="">Verify Your Mobile No.</h4>
                                            <p>Please enter the 4 digit code sent to <span class="fw-semibold">92********71</span></p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form autocomplete="off">
                                                ...
                                                <div class="mt-3">
                                                     <a href="index.php" class="btn btn-success w-100" type="submit">confirm</a>
