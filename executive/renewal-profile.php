                                        ...
                                        <div class="table-responsive table-card">
                                            <table class="table align-middle" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    $conn = $pdo->open();
                                                    try{
                                                    $stmt = $conn->prepare("SELECT * FROM tbl_profile where executive_id='".$admin['e_id']."' Order By expire_date DESC");
                                                    $cnt=1;
                                                    $stmt->execute();
                                                    foreach($stmt as $row){
                                                    ?>   
                                                    <tr>
                                                        ...
                                                        <td class="tags">
                                                               <span class="badge bg-primary-subtle text-primary"><?php echo $row['status'];?></span>
                                                        </td>
                                                        <td>
                                                        <div class="dropdown">
