...
<!-- auth-logout-cover12:36:28 GMT -->
<head>

    <meta charset="utf-8" />
    <title>Log Out | QuickSearchOnline - Admin & Dashboard Template</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 text-center">
                                        ...
                                        <div class="mt-4 pt-2">
                                            ...
                                            <p class="text-muted">Thank you for using <span class="fw-semibold">Quick Search Online </span> Executive-Portal</p>
                                            <div class="mt-4">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">
                                Copyright &copy; <script>document.write(new Date().getFullYear())</script> Quick Search Online <i class="mdi mdi-heart text-danger"></i>  by COFA Studio
                            </p>
                        </div>
                    </div>
                </div>
