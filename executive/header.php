                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo $admin['executive_name'];?>
                                           </span>
                                        <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Executive</span>
                                    </span>
                                </span>
                            </button>
