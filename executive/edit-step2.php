                      ...
                      <div class="row">
                        <div class="col-xxl-6">
                            <div class="card">
                                    ...
                                    <h4 class="card-title mb-0 flex-grow-1"><span class="text-blue-5">Step 3 :</span> Add Product & Services</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form action="javascript:void(0);" class="row g-3">
                                            <span ><span class="text-red">* </span> 1 Mandatory to fill  </span>
                                            <div class="col-md-6">
                                               <!-- <label for="fullnameInput" class="form-label">Name</label>-->
                                                <input type="text" class="form-control" id="product1" placeholder="Add Your Products">
                                            </div>
                                            <div class="col-md-6">
                                               <!-- <label for="fullnameInput" class="form-label">Name</label>-->
                                                <input type="text" class="form-control" id="product2" placeholder="Add Your Products">
                                            </div>
                                            <div class="col-md-6">
                                                
                                                <input type="text" class="form-control" id="product3" placeholder="Add Your Products">
                                            </div>
                                            <div class="col-md-6">
                                                
                                                <input type="text" class="form-control" id="product4" placeholder="Add Your Products">
                                            </div>
                                            <div class="col-12">
                                               <button type="button" class="btn btn-info
                                             add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#"><i class="ri-add-line align-bottom me-1"></i> Add More</button>
                                            </div>
                                    ...
                                    <div class="live-preview">
                                        <form action="javascript:void(0);">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3"placeholder="Enter URL">
                                                    </div>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            ...
                                            <div class="d-flex align-items-start gap-3 mt-5">
                                                    <a class="btn btn-link text-decoration-none btn-label previestab" href="edit-step1.php" role="button"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i> Back </a>
                                                   <!-- <button type="button" class="btn btn-link text-decoration-none btn-label previestab" data-previous="pills-gen-info-tab"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i> Back to General</button>-->
                                                    <a class="btn btn-success btn-label right ms-auto nexttab nexttab" href="edit-step4.php" role="button"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Next</a>
                                                </div>
                                        </form>
                                    </div>
                                    <div class="d-none code-view">
