...
<?php
	...
	$user_id=$_POST['user_id'];
		...
		try{
			$stmt = $conn->prepare("UPDATE tbl_profile SET user_id=:user_id, profile_id=:profile_id, fb=:fb, google=:google, linkdin=:linkdin, youtube=:youtube, insta=:insta WHERE profile_id=:profile_id");
			$stmt->execute(['user_id'=>$user_id,'profile_id'=>$profile_id, 'fb'=>$fb, 'google'=>$google, 'linkdin'=>$linkdin, 'youtube'=>$youtube, 'insta'=>$insta]);
