...
<?php
	...
	$id = rand();
		...
		try{
	    	...
	    	$stmt1 = $conn->prepare("INSERT INTO users ( id, franchise_id, name, email, contact_info, password, status) VALUES (:id, :franchise_id, :name , :email, :contact_info, :password, :status)");
			$stmt1->execute(['id'=>$id, 'franchise_id'=>$franchise_id, 'name'=>$contact_person, 'email'=>$email, 'contact_info'=>$phone, 'password'=>$password, 'status'=>$status]);
