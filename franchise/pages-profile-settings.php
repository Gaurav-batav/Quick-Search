                            ...
                            <div class="card mt-n5">
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <h5 class="fs-16 mb-1">Shrikant Khadang </h5>
                                        <p class="text-muted mb-0">Franchise Owner</p>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                        ...
                        <div class="col-xxl-9">
                            <div class="card mt-xxl-n5">
                                <div class="card-header">
                                    <ul class="nav  rounded card-header-tabs border-bottom-0" role="tablist">
                                        <li class="nav-item">
                                            <h5><a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" placeholder="Enter your firstname" value="Shrikant">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="lastnameInput" placeholder="Enter your lastname" value="Khadang">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="lastnameInput" class="form-label">Franchise Name</label>
                                                            <input type="text" class="form-control" id="lastnameInput" placeholder="Enter your Franchise Name" value="xyz">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="phonenumberInput" placeholder="Enter your phone number" value="+(91) 1234567891">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                     <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="phonenumberInput" class="form-label">Alternative Phone Number</label>
                                                            <input type="text" class="form-control" id="phonenumberInput" placeholder="Enter your phone number" value="+(91) 1234567891">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="phonenumberInput" class="form-label">Landline Number</label>
                                                            <input type="text" class="form-control" id="phonenumberInput" placeholder="Enter your Landline number" value="+(91) 1234567891">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                     <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="phonenumberInput" class="form-label">Alternative Landline Number</label>
                                                            <input type="text" class="form-control" id="phonenumberInput" placeholder="Enter your Landline number" value="+(91) 1234567891">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter your email" value="ShrikantKhadang@gmail.com">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="emailInput" class="form-label">Alternative Email Address</label>
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter your email" value="ShrikantKhadang@gmail.com">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="designationInput" placeholder="Designation" value="Franchise Owner">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="emailInput" class="form-label">Aadhaar Card No</label>
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter Aadhaar No" >
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                     <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="emailInput" class="form-label">Pan Card No</label>
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter Pan No" >
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                     <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="emailInput" class="form-label">GST</label>
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter GST" >
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter your city" >
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter your State" >
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter your Address" >
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <!--<div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="websiteInput1" placeholder="www.example.com" value="www.QuickSearchOnline.com" />
                                                        </div>
                                                    </div>-->
                                                    <!--end col-->
