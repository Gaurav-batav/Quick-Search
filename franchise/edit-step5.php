                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1"><span class="text-blue-5">Step 6 :</span> Business Hour</h4>
                                   ...
                                   <!-- <p class="text-muted">More complex forms can be built using our grid classes. Use these for form layouts that require multiple columns, varied widths, and additional alignment options. <span class="fw-medium">Requires the <code>$enable-grid-classes</code> Sass variable to be enabled</span> (on by default).</p>-->
                                    <div class="live-preview">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationDefault04 " class="form-label me-3 ">Monday</label>
                                                <input type="checkbox" id="" name="" value="">
                                                <label for=""> Closed</label><br>
                                                    <div class="mb-4">
                                                        
                                                        <label for="validationDefault04" class="form-label">Open At</label>
                                                            <select class="form-select mb-4" id="validationDefault04" required>
                                                                <option selected disabled value="">Choose Open Time</option>
                                                                <option >00.00</option>
                                                                  <option>01:00</option>
                                                                  <option >02:00</option>
                                                                  <option >03:00</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mt-4">
                                                        <label for="validationDefault04" class="form-label">Closed At</label>
                                                            <select class="form-select mb-4" id="validationDefault04" required>
                                                                <option selected disabled value="">Choose Closed Time</option>
                                                                <option >00.00</option>
                                                                  <option>01:00</option>
                                                                  <option >02:00</option>
                                                                  <option >03:00</option>
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationDefault04 " class="form-label me-3 ">Tuesday</label>
                                                <input type="checkbox" id="" name="" value="">
                                                <label for=""> Closed</label><br>
                                                    <div class="mb-4">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationDefault04 " class="form-label me-3">Wednesday</label>
                                                <input type="checkbox" id="" name="" value="">
                                                <label for=""> Closed</label><br>
                                                    <div class="mb-4">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationDefault04 " class="form-label me-3">Thursday</label>
                                                <input type="checkbox" id="" name="" value="">
                                                <label for=""> Closed</label><br>
                                                    <div class="mb-4">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationDefault04 " class="form-label me-3">Friday</label>
                                                <input type="checkbox" id="" name="" value="">
                                                <label for=""> Closed</label><br>
                                                    <div class="mb-4">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationDefault04 " class="form-label me-3">Saturday</label>
                                                <input type="checkbox" id="" name="" value="">
                                                <label for=""> Closed</label><br>
                                                    <div class="mb-4">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mt-4">
                                                        <label for="validationDefault04" class="form-label">Closed At</label>
                                                            <select class="form-select mb-4" id="validationDefault04" required>
                                                                <option selected disabled value="">Choose Close Time</option>
                                                                <option >00.00</option>
                                                                  <option>01:00</option>
                                                                  <option >02:00</option>
                                                                  <option >03:00</option>
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationDefault04 " class="form-label me-3">Sunday</label>
                                                <input type="checkbox" id="" name="" value="">
                                                <label for=""> Closed</label><br>
                                                    <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-start gap-3 mt-4">
                                                     <a class="btn btn-link text-decoration-none btn-label previestab" href="edit-step4.php" role="button"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i> Back</a>
                                                     <a class="btn btn-success btn-label right ms-auto nexttab nexttab" href="edit-step6.php" role="button"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Submit</a>
