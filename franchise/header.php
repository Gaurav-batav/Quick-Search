...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | QuickSearchOnline - Admin & Dashboard </title>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                                <div data-simplebar style="max-height: 320px">
                                    ...
                                    <div class="notification-list">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                            <div class="d-flex">
                                                <img src="assets/images/users/avtar.jpg"
                                                    class="me-3 rounded-circle avatar-xs" alt="user-pic" />
                                                <div class="flex-grow-1">
                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="assets/images/users/avtar.jpg" alt="Header Avatar" />
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo $admin['franchise_name'];?>
                                           </span>
                                        <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Franchise</span>
                                    </span>
                                </span>
                            </button>
