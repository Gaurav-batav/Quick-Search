                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input type="text" name="alt_email" class="form-control" placeholder="Enter contact email"  />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div>
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input type="text" name="adhar_no" class="form-control" placeholder="Enter Adhaar Card No." requied />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div>
