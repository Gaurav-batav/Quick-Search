                                    ...
                                    <div class="live-preview">
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="labelInput"placeholder="Enter Contact Person Name">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-3 col-md-6">
                                            ...
                                            <!--end col-->
                                             <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    <label for="labelInput" class="form-label">Enter Whatsapp No</label>
                                                    <input type="text" class="form-control" id="labelInput"placeholder="Whatsapp No">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="labelInput-view"placeholder="Enter Landline No">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="labelInput-view"placeholder="Enter Alternative Landline No">
                                                </div>
                                            </div>
                                            <!--end col-->
                                             ...
                                             <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="EmailInput" placeholder="Enter Email Address">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="EmailInput" placeholder="Enter Alternative Email Address">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="websiteInput" placeholder="www.wxample.com">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-3 col-md-6">
                                            ...
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="ZipCodeInput"minlength="5" maxlength="6" placeholder="Enter zipcode" >
                                                </div>
                                            </div>
                                            <!--end col-->
                                             <div class="col-lg-8">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="ZipCodeInput"minlength="5" maxlength="6" placeholder="Enter Your Address" >
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div>
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea5" rows="3" placeholder="Enter Description"></textarea>
                                                </div>
                                        ...
                                        <!--<div class="col-12">
                                             ...
                                             <div class="d-flex align-items-start gap-3 mt-4">
                                                <a class="btn btn-link text-decoration-none btn-label previestab" href="edit-stepIndustry.php" role="button"><i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i> Back </a>
                                                <a class="btn btn-success btn-label right ms-auto nexttab nexttab" href="edit-step2.php" role="button"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Next</a>
                                                    <!--<button type="button" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="pills-info-desc-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Go to more info</button>-->
                                                </div>
