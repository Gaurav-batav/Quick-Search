                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Free Profile Data</h4>
                                        ...
                                        <div class="table-responsive table-card">
                                            <table class="table align-middle" id="customerTable">
                                                ...
                                                <?php
                                                    $conn = $pdo->open();
                                                    try{
                                                    $stmt = $conn->prepare("SELECT * FROM tbl_profile where status='Free' Order By creation_on DESC");
                                                    $cnt=1;
                                                    $stmt->execute();
                                                    foreach($stmt as $row){
                                                ?>   
                                                    <tr>
                                                        ...
                                                        <td class="tags">
                                                               <span class="badge bg-info-subtle text-info"><?php echo $row['status'];?></span>
                                                        </td>
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    <li ><a href="../html2024/index.php"> <button class="dropdown-item" href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="25000351">
                                                                    <i class="ri-eye-fill align-bottom me-2 text-muted"></i> View Profile</button></a></li>
                                                                    <li ><a href="edit-stepIndustry.php"> <button class="dropdown-item" href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="25000351">
